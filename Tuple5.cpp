...
/*
The work of tie() is to unpack the tuple values into seperate variables. There are two variants of tie(), 
...
{    
    ...
    // ignores char value 
    tie(i_val,ignore,f_val) = tup1;  //should be same order of constructed 
